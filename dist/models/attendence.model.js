...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => employee_model_1.default),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER,
        allowNull: false,
    }),
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => employee_model_1.default),
...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('Present', 'Absent', 'Holiday', 'Late', 'Leave'),
        allowNull: false,
        defaultValue: 'Absent',
